                    ...
                    <CardContent>
                        {healthReport ? (
                            <div className="grid gap-3">
                                ...
                                <InfoRow
                                    label="Миграций"
                                    value={String(healthReport.migrations.appliedCount)}
                                />
                    ...
                    <CardContent>
                        {dataQualityReport ? (
                            <div className="grid gap-3">
                                ...
                                <InfoRow
                                    label="Проверок"
                                    value={String(dataQualityReport.summary.totalChecks)}
                                />
                                <InfoRow
                                    label="Пройдено"
                                    value={String(dataQualityReport.summary.passedChecks)}
                                />
                                <InfoRow
