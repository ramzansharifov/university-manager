...
export function ReportsPage(): ReactElement {
  ...
  const groupLessonSessions = useMemo(
    () =>
      lessonSessions.filter((session) =>
        groupScheduleItemIds.has(Number(session.schedule_item_id))
      ),
  ...
  const scoreValues = groupGrades
    .filter((grade) => {
      const gradeItem = groupGradeItems.find(
        ...
        <CardHeader>
          <div className="flex flex-col gap-3 xl:flex-row xl:items-start xl:justify-between">
            <div>
              ...
              <CardDescription>
                Выбери факультет, специальность и группу. Отчёты строятся по всем дисциплинам
                выбранной группы.
              </CardDescription>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <Button variant="secondary" disabled={!selectedGroup} onClick={handleExportSummary}>
                <FiDownload />
                CSV сводка
              </Button>
              <Button
        ...
        <>
          <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            ...
            <MetricCard
              ...
              value={String(groupAttendanceRecords.length)}
            />
          </div>
          ...
          <div className="grid gap-4 xl:grid-cols-2">
            ...
            <Card className="xl:col-span-2">
              <CardHeader>
                ...
                <CardDescription>
                  Сравнение проведённых занятий по дисциплинам. Рядом указано, сколько пар уже
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Сводная таблица по оценкам, pass/fail работам и посещаемости студентов выбранной
                группы.
              </CardDescription>
            </CardHeader>
            <CardContent>
...
function createStudentReportRow({
  ...
  const studentGrades = groupGrades.filter(
    (grade) => Number(grade.student_id) === Number(student.id)
  )
