...
export function StudentDetailsPage() {
  ...
  const gradeDisciplineOptions = useMemo(() => createGradeDisciplineOptions(gradeRows), [gradeRows])
                ...
                <Card className="overflow-hidden">
                    ...
                    <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <CardDescription>
                            Итоговые оценочные элементы по семестрам: экзамены, зачёты и другие
                      ...
                      <div className="grid gap-2 sm:grid-cols-3 lg:min-w-[460px]">
                        ...
                        <MetricCard
                          label="Средний балл"
                          value={
                            finalGradeStats.average === null
                              ? '—'
                              : finalGradeStats.average.toFixed(1)
                          }
                        />
                        <MetricCard
                          label="Дисциплин"
                  ...
                  <CardContent className="p-4">
                    {recordBookGroups.length > 0 ? (
                      ...
                      <EmptyState>
                        Итоговых оценочных элементов пока нет. Они появятся здесь после заполнения
                        финальных оценок.
                      </EmptyState>
                    )}
                  </CardContent>
